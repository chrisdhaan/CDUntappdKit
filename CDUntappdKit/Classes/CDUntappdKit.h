...
typedef void (^CDUntappdKitResultBlock)(id responseObject, NSError *error);
...
typedef NS_ENUM(NSInteger, CDUntappdWishListSortType) {
    CDUntappdWishListSortTypeMostRecent,
    CDUntappdWishListSortTypeMostCheckins,
    CDUntappdWishListSortTypeHighestRated,
    CDUntappdWishListSortTypeLowestRated,
    CDUntappdWishListSortTypeHighestABV,
    CDUntappdWishListSortTypeLowestABV
};
...
typedef NS_ENUM(NSInteger, CDUntappdDistinctBeerSortType) {
    CDUntappdDistinctBeerSortTypeMostRecent,
    CDUntappdDistinctBeerSortTypeMostCheckins,
    CDUntappdDistinctBeerSortTypeHighestRated,
    CDUntappdDistinctBeerSortTypeLowestRated,
    CDUntappdDistinctBeerSortTypeHighestRatedByYou,
    CDUntappdDistinctBeerSortTypeLowestRatedByYou
};

typedef NS_ENUM(NSInteger, CDUntappdBeerSearchSortType) {
    CDUntappdBeerSearchSortTypeAlphabetical,
    CDUntappdBeerSearchSortTypeMostCheckins
};

typedef NS_OPTIONS(NSInteger, CDUntappdCheckinPostTo) {
    CDUntappdCheckinPostToFacebook   = (1 << 0),
    CDUntappdCheckinPostToTwitter    = (1 << 1),
...
@property (strong, nonatomic) AFHTTPSessionManager *authenticationSessionManager;
@property (strong, nonatomic) CDUntappdAPIClient *untappdAPIClient;
...
/**
 ...
 @param completion A block to be called upon completion; will get passed the response body and error if one occurred.
 */
- (void)infoForUser:(NSString *)username compact:(BOOL)compact completion:(CDUntappdKitResultBlock)completion;
