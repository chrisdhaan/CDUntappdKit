...
HOSTING_BASE_PATH="CDUntappdKit"
DOCS_ROOT="/$HOSTING_BASE_PATH/documentation/cduntappdkit/"
...
<body>
  <p>Redirecting to <a href="$DOCS_ROOT">CDUntappdKit documentation</a>…</p>
</body>
</html>
EOF
...
<head>
  <meta charset="utf-8">
  <title>CDUntappdKit Documentation</title>
