...
Part of the v3.2.0 "Client Configurability" release, which will not be tagged/released until the sibling Response Caching and Decoder Configuration work has also merged.
